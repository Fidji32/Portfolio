...
const skillsSection = {
  ...
  subTitle: "UN PEU DE TOUT CAR J'ADORE AGRANDIR MON ÉVENTAIL DE COMPÉTENCES",
  skills: [
    emoji(
      "⚡ Sécurisation et optimisation du déploiement d'applications"
    ),
    emoji(
      "⚡ Gestion fiable et efficace des réseaux informatiques"
    ),
    emoji(
      "⚡ Conception et implémentation de logiciels et d'algorithmes"
    )
  ],
...
const techStack = {
  ...
  experience: [
    {
      Stack: "Ingénierie réseau", //Insert stack or technology you have experience in
      progressPercentage: "85%" //Insert relative proficiency in percentage
    },
    {
      Stack: "Déploiement de services",
  ...
  experience: [
    {
      ...
      desc: "Contribution à la modernisation de l'entreprise par le développement d'une application innovante dédiée à l'optimisation des processus de stock, production, et ventes. Réalisation d'un guide utilisateur complet, suivi de tests en conditions réelles, et gestion de la maintenance de l'application pour assurer un impact durable sur les opérations de l'entreprise.",
      // descBullets: [
